...
(base) ian-martin-ajzenszmidt@ian-martin-ajzenszmidt-CFSZ5-3:~$ nano legendre.py.py
(base) ian-martin-ajzenszmidt@ian-martin-ajzenszmidt-CFSZ5-3:~$ cat legendre.py
import numpy as np
import math
...
if __name__ == "__main__":
    ...
    plt.tight_layout()
    plt.show()
(base) ian-martin-ajzenszmidt@ian-martin-ajzenszmidt-CFSZ5-3:~$ cat legendre2.py
cat: legendre2.py: No such file or directory
(base) ian-martin-ajzenszmidt@ian-martin-ajzenszmidt-CFSZ5-3:~$ python3 legendre2.py
python3: can't open file '/home/ian-martin-ajzenszmidt/legendre2.py': [Errno 2] No such file or directory
(base) ian-martin-ajzenszmidt@ian-martin-ajzenszmidt-CFSZ5-3:~$ python3 legendre.py
Max reconstruction error: 6.448e-01
RMS reconstruction error: 6.144e-02
Max orthogonality deviation (Lmax=5): 9.877e-01
